...
namespace miniprojet.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult authentification(Login_ l)
        {
            bool isValid = false;
            DataTable obj = new DataTable();
            ...
            try
            {
                string query = "SELECT TOP (1000) [login], [password] FROM [mini].[dbo].[usr]";
        ...
        public ActionResult list_of_brands()
        {
        ...
        public ActionResult cars_datails()
        {
